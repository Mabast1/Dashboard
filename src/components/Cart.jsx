  ...
  return (
    <div className=" bg-half-transparent w-full fixed nav-item top-0 right-0">
      <div className=" float-right h-screen duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484852] bg-white md:w-400 p-8">
        ...
        <div className="flex items-center leading-8 gap-5 border-b-1 border-color dark:border-gray-50" />
        <div className="mt-5">
          {cartData.map((item, index) => (
            <div key={index}>
              <div>
                <div className="flex items-center leading-8 gap-5 border-b-1 pb-4 pt-2 border-color dark:border-gray-50">
                  <img
                  ...
                  <div>
                    ...
                    <div className="flex gap-4 mt-2 items-center justify-between">
                      ...
                      <div className=" flex items-center border-1 border-r-0 border-color rounded">
                        ...
                        <p className=" p-2 border-r-1 dark:border-gray-600 border-color">
                          0
                        </p>
